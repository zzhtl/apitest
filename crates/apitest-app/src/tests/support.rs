...
pub(super) fn test_app(context: &mut eframe::CreationContext<'_>) -> ApiTestApp {
    ...
    ApiTestApp {
        ...
        body_store: None,
        run_records: Vec::new(),
        history_max_records: crate::services::history::HISTORY_MAX_RECORDS,
        history_max_age_days: crate::services::history::HISTORY_MAX_AGE_DAYS,
        selected_history: 0,
        ...
        last_backup: None,
        cookie_jar: std::sync::Arc::new(apitest_runtime::PersistentCookieJar::default()),
        cookies_dirty: false,
